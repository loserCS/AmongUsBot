...
GITHUB = 'https://github.com/loserCS/AmongUsBot'  # TODO: Use git API to get link to repo?
...
class HelpCog(commands.Cog):
    ...
    async def on_ready(self):
        ...
        activity = discord.Activity(type=discord.ActivityType.watching, name="for a!help")
